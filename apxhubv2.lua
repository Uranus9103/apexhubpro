...
ImageButton.Image="http://www.roblox.com/asset/?id=101336911409270"
...
--- #Thông Báo
Tabs.Info:AddButton({
        Title="APE HUB (subcakevn)",
        Description="Tiktok",
        Callback=function()
            setclipboard(tostring("https://www.tiktok.com/@doikhongnoi")) 
        end
})
Tabs.Info:AddButton({
    Title="SubcakeVN",
...
Tabs.Info:AddButton({
    ...
    Description="Capcut",
    Callback=function()
        setclipboard(tostring("https://mobile.capcutshare.com/s/Zs8PB2A8T/"))
    end
})
Tabs.Info:AddParagraph({
    Title="Phát Triển bởi Thịnh (SCV)",
    Content=""
})
local executorName
...
Tabs.Info:AddParagraph({
    Title="Cập Nhật",
    Content="Mình Sẽ Cập Nhiều Nhiều Tính Năng Hơn Để Mang Đến Cho Các Bạn Trải Nghiệm Tốt Nhất\nNếu Có Lỗi Hãy Kiên Nhẫn Chờ Mình Fix Hoặc Gửi Ý Kiến Trên YTB Vì Mình Không Thể Thử Nghiệm Hết"
})
Tabs.Info:AddParagraph({
